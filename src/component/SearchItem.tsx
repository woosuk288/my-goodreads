      ...
      <Box sx={sxBookInfoColumn}>
        <CardContent className="book_info">
          ...
          <div className="book_meta_info">
            ...
            <div className="book_supplemental_info">
              <Typography className="book_publication_date" color="text.secondary" component='span' marginRight='12px'>Published 2013</Typography>
              <Link href="https://www.goodreads.com/work/editions/21998914-give-and-take-a-revolutionary-approach-to-success">80 Editions</Link>
            </div>
          </div>
        </CardContent>
        <Box sx={sxBookUserShelfAction}>
          <div className="wtr_wrapper">
            ...
            <IconButton sx={{ width: '40px', height: '36.5px', boxShadow: 2, borderRadius: '0 4px 4px 0', color: 'primary.light', bgcolor: 'secondary.main', ":hover": { bgcolor: 'secondary.main' } }} >
              <LibraryBooksIcon />
            </IconButton>
          </div>
